...
export const pricing = [
    {
        name: "Spark",
        price: "From $649",
        desc: "A focused entry point for brands that need a clean, high-quality digital presence without unnecessary complexity.",
        features: [
            "Single-page or landing experience",
    ...
    },
    {
        name: "Growth",
        price: "From $1,199",
        desc: "A scalable, high-performance website designed for growing brands that need depth, flexibility, and refined user experience.",
        features: [
            "4–8 custom-designed pages",
            "Advanced UI/UX for engagement",
            "Performance-optimized development",
            "CMS integration for content control",
    ...
    },
    {
        name: "Signature",
        price: "From $2,999",
        desc: "A fully bespoke digital experience crafted with strategic depth, advanced interactions, and premium execution.",
        features: [
            "Custom design system architecture",
            "Component-based scalable development",
