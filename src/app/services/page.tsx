                        ...
                        {services.map((s) => (
                            <div key={s.n} className="sv-row" style={{borderBottom: "1px solid var(--c-rule)"}}>
                                <button onClick={() => setActive(active === s.n ? null : s.n)}
                                    ...
                                    <motion.span animate={{rotate: active === s.n ? 45 : 0}}
                                            ...
                                            <div style={{
                                                ...
                                                <div>
                                                    <p className="t-body-lg"
                                                       style={{maxWidth: 560, marginBottom: "1.5rem"}}>{s.body}</p>
                ...
                <div className="wrap sv-pricing" style={{
                    ...
                    <div className="sv-head" style={{marginBottom: "clamp(4rem,7vw,9rem)"}}>
                        ...
                        <div className="line-clip">
                            <div className="reveal-line t-h1">Transparent.</div>
                        </div>
                        <div className="line-clip">
                            <div className="reveal-line t-h1" style={{color: "var(--c-rule2)"}}>No surprises.</div>
                        </div>
                    </div>
                    ...
                    <div style={{
                        ...
                        {pricing.map(plan => (
                            <div key={plan.name} className="sv-price-card" style={{
                                ...
                                <p className="t-label" style={{
                                    marginBottom: "1.5rem",
                                    color: plan.highlight ? "rgba(248,247,244,.4)" : undefined
                                }}>{plan.name}</p>
                                <div style={{
                                ...
                                <p className="t-body" style={{
                                    marginBottom: "2.5rem",
                                    fontSize: ".9rem",
                                    color: plan.highlight ? "rgba(248,247,244,.5)" : undefined,
                                    lineHeight: 1.7
                                }}>{plan.desc}</p>
                                <ul style={{
                                    listStyle: "none",
                      ...
                      <span style={{
                          ...
                          width: 14,
                          height: 14,
                          border: `1px solid ${plan.highlight ? "rgba(248,247,244,.2)" : "var(--c-rule)"}`,
                          display: "flex",
                          alignItems: "center",
                        ...
                        <span style={{
                            width: 5,
                            height: 5,
                            background: plan.highlight ? "rgba(248,247,244,.6)" : "var(--c-ink2)",
                            display: "block"
                        }}/>
                      </span>
                                            <span style={{
                                                ...
                                                fontSize: ".85rem",
                                                color: plan.highlight ? "rgba(248,247,244,.7)" : "var(--c-ink2)",
                                                fontWeight: 300,
                                                lineHeight: 1.5
                                            }}>{f}</span>
                                        </li>
                    ...
                    <p className="t-body" style={{textAlign: "center", marginTop: "2rem", fontSize: ".85rem"}}>
                        Not sure which fits? <a href="/contact" style={{
                        color: "var(--c-ink)",
